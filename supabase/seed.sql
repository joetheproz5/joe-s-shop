...
insert into public.product_categories (product_id, category_id) values
  ('a0000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000001'), -- phone -> smartphones
  ('a0000000-0000-0000-0000-000000000002', 'c1000000-0000-0000-0000-000000000002'), -- laptop -> laptops
  ('a0000000-0000-0000-0000-000000000003', 'c1000000-0000-0000-0000-000000000003'), -- headphones -> audio
  ('a0000000-0000-0000-0000-000000000004', 'c2000000-0000-0000-0000-000000000001'), -- denim -> men
  ('a0000000-0000-0000-0000-000000000005', 'c2000000-0000-0000-0000-000000000002'), -- dress -> women
  ('a0000000-0000-0000-0000-000000000006', 'c2000000-0000-0000-0000-000000000003'), -- kids set -> kids
  ('a0000000-0000-0000-0000-000000000007', 'c3000000-0000-0000-0000-000000000001'), -- sofa -> furniture
  ('a0000000-0000-0000-0000-000000000008', 'c3000000-0000-0000-0000-000000000002'), -- coffee -> appliances
  ('a0000000-0000-0000-0000-000000000009', 'c3000000-0000-0000-0000-000000000003'), -- vase -> decor
  ('a0000000-0000-0000-0000-000000000010', 'c0000000-0000-0000-0000-000000000004'), -- yoga -> sports
  ('a0000000-0000-0000-0000-000000000011', 'c0000000-0000-0000-0000-000000000004'), -- bands -> sports
  ('a0000000-0000-0000-0000-000000000012', 'c0000000-0000-0000-0000-000000000005'); -- book -> books

-- ======================================================================
-- PRODUCT TAGS
-- ======================================================================
insert into public.product_tags (product_id, tag) values
  ('a0000000-0000-0000-0000-000000000001', 'flagship'), ('a0000000-0000-0000-0000-000000000001', '5g'), ('a0000000-0000-0000-0000-000000000001', 'titanium'),
  ('a0000000-0000-0000-0000-000000000002', 'laptop'), ('a0000000-0000-0000-0000-000000000002', 'lightweight'), ('a0000000-0000-0000-0000-000000000002', 'pro'),
  ('a0000000-0000-0000-0000-000000000003', 'audio'), ('a0000000-0000-0000-0000-000000000003', 'wireless'), ('a0000000-0000-0000-0000-000000000003', 'anc'),
  ('a0000000-0000-0000-0000-000000000004', 'denim'), ('a0000000-0000-0000-0000-000000000004', 'jacket'), ('a0000000-0000-0000-0000-000000000004', 'cotton'),
  ('a0000000-0000-0000-0000-000000000005', 'dress'), ('a0000000-0000-0000-0000-000000000005', 'linen'), ('a0000000-0000-0000-0000-000000000005', 'summer'),
  ('a0000000-0000-0000-0000-000000000010', 'yoga'), ('a0000000-0000-0000-0000-000000000010', 'fitness'), ('a0000000-0000-0000-0000-000000000010', 'eco');
...
insert into public.product_images (product_id, url, alt_text, sort_order, is_featured) values
  ('a0000000-0000-0000-0000-000000000001', 'https://placehold.co/800x800/1e3a8a/white?text=UltraPhone+15+Pro', 'UltraPhone 15 Pro front', 0, true),
  ('a0000000-0000-0000-0000-000000000001', 'https://placehold.co/800x800/1e3a8a/white?text=UltraPhone+15+Pro+Back', 'UltraPhone 15 Pro back', 1, false),
  ('a0000000-0000-0000-0000-000000000002', 'https://placehold.co/800x800/0f172a/white?text=ProBook+Air+14', 'ProBook Air 14', 0, true),
  ('a0000000-0000-0000-0000-000000000002', 'https://placehold.co/800x800/0f172a/white?text=ProBook+Air+14+Side', 'ProBook Air 14 side', 1, false),
  ('a0000000-0000-0000-0000-000000000003', 'https://placehold.co/800x800/5c7cfa/white?text=SoundMax+Pro', 'SoundMax Pro headphones', 0, true),
  ('a0000000-0000-0000-0000-000000000003', 'https://placehold.co/800x800/5c7cfa/white?text=SoundMax+Pro+Box', 'SoundMax Pro in case', 1, false),
  ('a0000000-0000-0000-0000-000000000004', 'https://placehold.co/800x800/3b5bdb/white?text=Denim+Jacket', 'Classic denim jacket', 0, true),
  ('a0000000-0000-0000-0000-000000000005', 'https://placehold.co/800x800/f59f00/white?text=Summer+Maxi+Dress', 'Summer maxi dress', 0, true),
  ('a0000000-0000-0000-0000-000000000006', 'https://placehold.co/800x800/20c997/white?text=Kids+Adventure+Set', 'Kids adventure set', 0, true),
  ('a0000000-0000-0000-0000-000000000007', 'https://placehold.co/800x800/495057/white?text=Modern+Sofa+Set', 'Modern sofa set', 0, true),
  ('a0000000-0000-0000-0000-000000000008', 'https://placehold.co/800x800/868e96/white?text=Smart+Coffee+Maker', 'Smart coffee maker', 0, true),
  ('a0000000-0000-0000-0000-000000000009', 'https://placehold.co/800x800/ccb5b5/white?text=Ceramic+Vase+Set', 'Ceramic vase set', 0, true),
  ('a0000000-0000-0000-0000-000000000010', 'https://placehold.co/800x800/12b886/white?text=Pro+Yoga+Mat', 'Pro yoga mat', 0, true),
  ('a0000000-0000-0000-0000-000000000011', 'https://placehold.co/800x800/099268/white?text=Resistance+Bands', 'Resistance band set', 0, true),
  ('a0000000-0000-0000-0000-000000000012', 'https://placehold.co/800x800/7048e8/white?text=The+Art+of+Code', 'The Art of Code', 0, true);
...
insert into public.product_variants (product_id, sku, price, sale_price, cost_price, stock_quantity, color) values
  ('a0000000-0000-0000-0000-000000000001', 'TP-UP15P-BLK', 999.00, 899.00, 650.00, 45, 'Black'),
  ('a0000000-0000-0000-0000-000000000001', 'TP-UP15P-WHT', 999.00, 899.00, 650.00, 40, 'White'),
  ('a0000000-0000-0000-0000-000000000001', 'TP-UP15P-NVY', 999.00, 899.00, 650.00, 35, 'Navy');

-- ProBook Air 14
insert into public.product_variants (product_id, sku, price, cost_price, stock_quantity, color) values
  ('a0000000-0000-0000-0000-000000000002', 'TP-PBA14-GRY', 1299.00, 850.00, 35, 'Gray'),
  ('a0000000-0000-0000-0000-000000000002', 'TP-PBA14-SLV', 1299.00, 850.00, 30, 'Silver');

-- Denim Jacket sizes
insert into public.product_variants (product_id, sku, price, cost_price, stock_quantity, size) values
  ('a0000000-0000-0000-0000-000000000004', 'SH-CDJ-S', 129.00, 45.00, 20, 'S'),
  ('a0000000-0000-0000-0000-000000000004', 'SH-CDJ-M', 129.00, 45.00, 25, 'M'),
  ('a0000000-0000-0000-0000-000000000004', 'SH-CDJ-L', 129.00, 45.00, 25, 'L'),
  ('a0000000-0000-0000-0000-000000000004', 'SH-CDJ-XL', 129.00, 45.00, 15, 'XL');

-- Summer Maxi Dress
insert into public.product_variants (product_id, sku, price, cost_price, stock_quantity, size, color) values
  ('a0000000-0000-0000-0000-000000000005', 'SH-SMD-S-BLK', 89.00, 32.00, 15, 'S', 'Black'),
  ('a0000000-0000-0000-0000-000000000005', 'SH-SMD-M-BLK', 89.00, 32.00, 20, 'M', 'Black'),
  ('a0000000-0000-0000-0000-000000000005', 'SH-SMD-L-RED', 89.00, 32.00, 15, 'L', 'Red'),
  ('a0000000-0000-0000-0000-000000000005', 'SH-SMD-M-RED', 89.00, 32.00, 10, 'M', 'Red');
...
-- REVIEWS
-- ======================================================================
-- Reviews require real auth.users-backed profiles because public.profiles.id
-- references auth.users(id). Create customer accounts in the app, then add
-- reviews through the storefront or admin review tooling.
