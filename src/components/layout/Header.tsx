        ...
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <button
              onClick={toggleSearch}
              className={clsx(
                'flex items-center gap-2 rounded-lg p-2 transition-all xl:min-w-48 xl:bg-surface-100 xl:px-3 dark:xl:bg-surface-900',
            ...
            >
              ...
              <span className="hidden text-sm text-surface-500 xl:inline">Search products</span>
            </button>
